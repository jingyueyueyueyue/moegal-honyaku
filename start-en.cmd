...
echo   [2] Other GPU (CUDA 12.6)
echo   [3] CPU Mode (No GPU, MangaOCR/PaddleOCR)
echo   [4] CPU + PaddleOCR Mode (Recommended for low-spec servers)
set /p GPU_CHOICE=Enter option [1/2/3/4] (default 2): 
